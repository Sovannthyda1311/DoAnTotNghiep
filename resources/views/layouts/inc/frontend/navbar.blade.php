                    ...
                    <ul class="nav justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('cart')}}">
                                ...
                                <i class="fa fa-shopping-cart">
                                    <span class="cart-count-circle"><livewire:frontend.cart.cart-count/></span>
                                </i>
                                 </div>
                            </a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="{{url('/orders')}}"><i class="fa fa-shopping-cart"></i> My Orders</a></li>
                                <li>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                <i class="fa fa-bars" style="color: #542424;"></i>
            </button>
                          ...
                          <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                              <ul class="category-list">
                                <!-- Render category names dynamically -->
                                @foreach ($categories as $category)
                                <li class="category-item">
                                  <a class="category-link" href="#">{{ $category->name }}</a>
                                  <ul class="subcategory-list">
                                    <!-- Render subcategory names dynamically -->
                                    @foreach ($category->subcategories as $subcategory)
                                    <li class="subcategory-item">
                                      <a class="subcategory-link" href="{{ url('/fashions/' . $subcategory->slug) }}">{{ $subcategory->name }}</a>
                                    </li>
                                    @endforeach
                                  </ul>
                                </li>
