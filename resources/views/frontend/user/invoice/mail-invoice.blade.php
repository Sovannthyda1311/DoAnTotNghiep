...
<body>
    ...
    <div class="text-center">
        ...
        <p>
            Thank you for purching with {{$appSetting->website_name ?? "Online Clothes"}}.
            <br/>
        ...
        <thead>
            <tr>
                <th width="50%" colspan="2">
                    <h2 class="text-start">ONLINE CLOTHES</h2>
                </th>
                <th width="50%" colspan="2" class="text-end company-data">
                    <span>Invoice Id: #{{ $order->id }}</span> <br>
                    <span>Date: {{ date('d / m / Y')}}</span> <br>
                    <span>Phone Number: 0782454986</span> <br>
                    <span>Address: #23 Ta Quang Buu, Bach Khoa, Hai Ba Trung, Hanoi</span> <br>
                </th>
            </tr>
            <tr class="bg-blue">
    ...
    <br>
    <p class="text-center">
        Thank your for shopping with Online Clothes!!!
    </p>
