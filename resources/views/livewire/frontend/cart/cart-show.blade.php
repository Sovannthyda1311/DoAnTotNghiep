        ...
        <div class="container">
                                        ...
                                        <a href="{{'collections/'.$cartItem->product->category->slug.'/'.$cartItem->product->slug}}">
                                            <label class="product-name">
                                                ...
                                                @if ($cartItem->product->productImages)
                                                    ...
                                                    style="width: 50px; height: 67px" alt="{{ $cartItem->product->name}}">
                                                @else
                                                ...
                                                @if ($cartItem->productColor)
                                                    ...
                                                    @if ($cartItem->productSize)
                                                        and size: {{$cartItem->productSize->size->name}}
                                                    @endif
                                                @elseif ($cartItem->productSize)
                                                    with size: {{$cartItem->productSize->size->name}}
                                                @endif
            ...
            <div class="row">
                <div class="col-md-8 my-md-auto mt-3">
                    <h5>Get the best deals & offers <a href="{{'/'}}"> Shop now </a></h5>
                </div>
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        ...
                        <hr>
                        <a href="{{url('checkout')}}" class="btn btn-warning w-100"> Checkout <i class="fa fa-paper-plane"></i></a>
                    </div>
                </div>
            </div>
